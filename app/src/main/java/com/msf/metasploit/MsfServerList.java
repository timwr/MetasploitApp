...
import com.msf.metasploit.model.SavedRpcServer;
import com.msf.metasploit.rpc.Async;
import com.msf.metasploit.rpc.LoginException;
...
public class MsfServerList {
    ...
    public void loadSavedServerList() {
        ...
        if (jsonSessions != null) {
            Type listType = new TypeToken<ArrayList<SavedRpcServer>>() { }.getType();
